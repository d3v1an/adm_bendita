...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Inicio de session - Bendita Tentacion</title>

        <meta name="description" content="Sistema de administracion de bendita tentacion">
        ...
        <meta name="apple-mobile-web-app-title" content="Bendita Administrator">
